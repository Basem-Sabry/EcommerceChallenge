...
exports.AllProductsComponent = void 0;
var core_1 = require("@angular/core");
var AllProductsComponent = /** @class */ (function () {
    function AllProductsComponent(service, spinner) {
    ...
    AllProductsComponent.prototype.shortName = function (name) {
        return name.split(' ')[0] + name.split(' ')[1];
    };
    __decorate([
        core_1.Input()
    ], AllProductsComponent.prototype, "Products");
